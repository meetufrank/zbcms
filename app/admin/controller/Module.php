...
//                Db::execute("INSERT INTO `".$prefix."field` VALUES ('', '".$moduleid."', 'template', '模板', '', '0', '0', '0', '', '', '', 'template', '','1','', '99', '1', '1')");
                Db::execute("INSERT INTO `".$prefix."field` VALUES ('', '".$moduleid."', 'is_open', '开启状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'开启|1\r\n禁用|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)','1','', '97', '1', '1')");
                Db::execute("INSERT INTO `".$prefix."field` VALUES ('', '".$moduleid."', 'status', '状态', '', '0', '0', '0', '', '', '', 'radio', 'array (\n  \'options\' => \'发布|1\r\n定时发布|0\',\n  \'fieldtype\' => \'tinyint\',\n  \'numbertype\' => \'1\',\n  \'labelwidth\' => \'75\',\n  \'default\' => \'1\',\n)','1','', '98', '1', '1')");
            }
            if ($moduleid  !==false) {
                savecache('Module');
...
//                    $fieldtype = $files['type'][input('name')];
                ...
                if($data['setup']) {
                    ...
                    if($data['type']=='customize'){
                        $data['setup']['content']= base64_encode($data['setup']['content']);
                    }
                    if($data['type']=='checkbox_db' || $data['type']=='select_db'){
                        $data['setup']['name']= base64_encode($data['setup']['name']);
                        $data['setup']['where']= base64_encode($data['setup']['where']);
                    }
