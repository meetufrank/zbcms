...
Source Database       : zbcms

Target Server Type    : MYSQL
Target Server Version : 50714
File Encoding         : 65001

Date: 2018-11-20 14:10:38
*/
...
INSERT INTO `clt_admin` VALUES ('8', 'wangjin', '202cb962ac59075b964b07152d234b70', '2', '8234738438@qq.com', '0', '18767654897', '127.0.0.1', '1498815814', '0', '1', '');
...
INSERT INTO `clt_auth_group` VALUES ('2', '管理员', '1', '0,311,310,1,15,16,120,7,9,14,13,27,29,161,163,164,162,38,167,182,169,166,28,48,31,32,45,170,171,175,174,173,46,176,183,179,178,', '1465114224');
...
INSERT INTO `clt_auth_rule` VALUES ('312', 'Channel/index', '频道设置', '1', '1', '0', '', '', '311', '1', '1542689876', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('311', 'Channel', '直播频道管理', '1', '1', '0', 'icon-play', '', '0', '0', '1542688643', '1', '1');
INSERT INTO `clt_auth_rule` VALUES ('313', 'medialibrary', '媒体库', '1', '1', '0', 'icon-play', '', '0', '0', '1542689979', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('314', 'Medialibrary/index', '媒体库列表', '1', '1', '0', '', '', '313', '1', '1542690873', null, '1');
...
-- ----------------------------
-- Table structure for `clt_channel`
-- ----------------------------
DROP TABLE IF EXISTS `clt_channel`;
CREATE TABLE `clt_channel` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '直播频道主键id',
  `channel_name` varchar(255) DEFAULT NULL COMMENT '直播频道名称',
  `channel_logo` varchar(255) DEFAULT NULL COMMENT '直播频道logo',
  `addtime` varchar(255) DEFAULT NULL COMMENT '直播频道创建时间',
  `pushurl` varchar(500) DEFAULT NULL COMMENT '推流地址',
  `rtmpurl` varchar(500) DEFAULT NULL COMMENT '拉流rtmp地址',
  `flvurl` varchar(500) DEFAULT NULL COMMENT '拉流flv地址',
  `m3u8url` varchar(500) DEFAULT NULL COMMENT '拉流m3u8地址',
  `streamname` varchar(255) DEFAULT NULL COMMENT 'streamname  名称',
  `user_type` int(11) DEFAULT '0' COMMENT '0游客模式  1报名问卷 2验证码观看  3用户导入白名单  4微信',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_channel
-- ----------------------------

-- ----------------------------
-- Table structure for `clt_channels_users`
-- ----------------------------
DROP TABLE IF EXISTS `clt_channels_users`;
CREATE TABLE `clt_channels_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '直播频道账号信息表    主键id',
  `cu_name` varchar(255) DEFAULT NULL COMMENT '频道用户名称',
  `cu_img` varchar(255) DEFAULT NULL COMMENT '频道用户logo',
  `cid` int(11) DEFAULT NULL COMMENT '绑定直播频道id',
  `cu_date` varchar(255) DEFAULT NULL COMMENT '进入直播频道的时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=755 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_channels_users
-- ----------------------------
INSERT INTO `clt_channels_users` VALUES ('501', 'Frank', 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '36', '2018-03-22 16:48:51');
INSERT INTO `clt_channels_users` VALUES ('508', '互动直播-老K', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', '35', '2018-03-23 14:29:36');
INSERT INTO `clt_channels_users` VALUES ('503', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-23 14:27:16');
INSERT INTO `clt_channels_users` VALUES ('504', 'ken', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-23 14:27:36');
INSERT INTO `clt_channels_users` VALUES ('505', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-23 14:27:57');
INSERT INTO `clt_channels_users` VALUES ('506', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-23 14:28:02');
INSERT INTO `clt_channels_users` VALUES ('507', '互动直播-老K', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', '35', '2018-03-23 14:29:36');
INSERT INTO `clt_channels_users` VALUES ('502', '哈哈哈', 'https://static.mudu.tv/index/avatar.png', '36', '2018-03-22 16:57:16');
INSERT INTO `clt_channels_users` VALUES ('499', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:48:17');
INSERT INTO `clt_channels_users` VALUES ('500', 'Frank', 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '36', '2018-03-22 16:48:51');
INSERT INTO `clt_channels_users` VALUES ('498', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:48:04');
INSERT INTO `clt_channels_users` VALUES ('495', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:42:01');
INSERT INTO `clt_channels_users` VALUES ('496', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:44:16');
INSERT INTO `clt_channels_users` VALUES ('497', '郭孝娟', 'https://static.mudu.tv/index/avatar.png', '36', '2018-03-22 16:45:40');
INSERT INTO `clt_channels_users` VALUES ('494', '空空空空', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJeOZwicjtKoFOD7jHNibDu2d7zIic5cPMNLN2zBwib01Tpm700gIZ1XOJ5aAzo7WyqdXicZyicgrZiaGxzw/132', '36', '2018-03-22 16:37:32');
INSERT INTO `clt_channels_users` VALUES ('493', '西瓜桥', 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', '35', '2018-03-22 16:37:18');
INSERT INTO `clt_channels_users` VALUES ('492', '西瓜桥', 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', '35', '2018-03-22 16:37:05');
INSERT INTO `clt_channels_users` VALUES ('491', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:36:31');
INSERT INTO `clt_channels_users` VALUES ('490', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:35:46');
INSERT INTO `clt_channels_users` VALUES ('489', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:35:34');
INSERT INTO `clt_channels_users` VALUES ('488', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:35:23');
INSERT INTO `clt_channels_users` VALUES ('487', '郭孝娟', 'https://static.mudu.tv/index/avatar.png', '36', '2018-03-22 16:34:43');
INSERT INTO `clt_channels_users` VALUES ('486', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:34:25');
INSERT INTO `clt_channels_users` VALUES ('485', '西瓜桥', 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', '35', '2018-03-22 16:33:03');
INSERT INTO `clt_channels_users` VALUES ('484', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-22 16:32:26');
INSERT INTO `clt_channels_users` VALUES ('482', '郭孝娟', 'https://static.mudu.tv/index/avatar.png', '36', '2018-03-22 16:31:09');
INSERT INTO `clt_channels_users` VALUES ('483', '平底郭', 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', '36', '2018-03-22 16:31:55');
INSERT INTO `clt_channels_users` VALUES ('550', '西瓜桥', 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3pRCOCaxw2olYYR0wibCtCCQ/132', '43', '2018-08-22 13:22:29');
INSERT INTO `clt_channels_users` VALUES ('548', '安抚', 'https://static.mudu.tv/index/avatar.png', '43', '2018-08-22 13:22:00');
INSERT INTO `clt_channels_users` VALUES ('549', '╬═☆、燕子★、', 'http://thirdwx.qlogo.cn/mmopen/vi_32/pgD4zrNkXtRWvr8hxpSyrf26uzfvfiaR46vTGlugeLHsID5ZJ2IVVv2XoueUvXOFkVXaic36XmRSLHn3TW2Lylyg/132', '43', '2018-08-22 13:22:04');
INSERT INTO `clt_channels_users` VALUES ('547', '安抚', 'https://static.mudu.tv/index/avatar.png', '43', '2018-08-22 13:20:27');
INSERT INTO `clt_channels_users` VALUES ('546', '王方', 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83ericMPp2Cq4owha1JJTI4pV16rWN6iaSu0dT32RSReuffKVTibCF46mb8zJ3O4hWicM5vgUoa3dsULh9w/132', '41', '2018-07-02 16:52:30');
INSERT INTO `clt_channels_users` VALUES ('545', 'wangjin', 'https://static.mudu.tv/index/avatar.png', '41', '2018-07-02 16:51:45');
INSERT INTO `clt_channels_users` VALUES ('544', null, 'https://static.mudu.tv/index/avatar.png', '41', '2018-07-02 16:50:14');
INSERT INTO `clt_channels_users` VALUES ('543', 'wangjin', 'https://static.mudu.tv/index/avatar.png', '41', '2018-07-02 16:49:14');
INSERT INTO `clt_channels_users` VALUES ('542', 'wangjin', 'https://static.mudu.tv/index/avatar.png', '40', '2018-05-07 10:47:16');
INSERT INTO `clt_channels_users` VALUES ('541', '444', 'https://static.mudu.tv/index/avatar.png', '40', '2018-04-26 16:38:15');
INSERT INTO `clt_channels_users` VALUES ('539', 'admin', 'https://static.mudu.tv/index/avatar.png', '40', '2018-04-23 14:25:06');
INSERT INTO `clt_channels_users` VALUES ('540', 'aadfas', 'https://static.mudu.tv/index/avatar.png', '40', '2018-04-26 13:45:21');
INSERT INTO `clt_channels_users` VALUES ('538', 'wadfadf', 'https://static.mudu.tv/index/avatar.png', '40', '2018-04-17 19:28:16');
INSERT INTO `clt_channels_users` VALUES ('537', 'Ken', 'https://static.mudu.tv/index/avatar.png', '40', '2018-04-15 17:51:33');
INSERT INTO `clt_channels_users` VALUES ('536', 'admin', 'https://static.mudu.tv/index/avatar.png', '39', '2018-04-13 17:00:12');
INSERT INTO `clt_channels_users` VALUES ('535', 'admin', 'https://static.mudu.tv/index/avatar.png', '39', '2018-04-13 16:58:26');
INSERT INTO `clt_channels_users` VALUES ('534', 'admin', 'https://static.mudu.tv/index/avatar.png', '39', '2018-04-13 16:56:13');
INSERT INTO `clt_channels_users` VALUES ('532', 'lia', 'https://static.mudu.tv/index/avatar.png', '39', '2018-04-11 13:28:30');
INSERT INTO `clt_channels_users` VALUES ('533', 'admin', 'https://static.mudu.tv/index/avatar.png', '39', '2018-04-13 16:55:50');
INSERT INTO `clt_channels_users` VALUES ('531', 'asdf', 'https://static.mudu.tv/index/avatar.png', '38', '2018-04-11 13:23:07');
INSERT INTO `clt_channels_users` VALUES ('529', 'adfa', 'https://static.mudu.tv/index/avatar.png', '35', '2018-04-10 15:39:45');
INSERT INTO `clt_channels_users` VALUES ('530', 'adfa', 'https://static.mudu.tv/index/avatar.png', '38', '2018-04-10 15:42:04');
INSERT INTO `clt_channels_users` VALUES ('528', '互动直播-老K', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', '35', '2018-04-01 15:19:57');
INSERT INTO `clt_channels_users` VALUES ('527', '西瓜桥', 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', '35', '2018-04-01 15:19:02');
INSERT INTO `clt_channels_users` VALUES ('526', 'Frank', 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '35', '2018-04-01 15:18:57');
INSERT INTO `clt_channels_users` VALUES ('525', 'Frank', 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '35', '2018-04-01 15:18:57');
INSERT INTO `clt_channels_users` VALUES ('524', '互动直播-老K', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', '35', '2018-04-01 15:18:48');
INSERT INTO `clt_channels_users` VALUES ('523', '互动直播-老K', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', '35', '2018-04-01 15:18:48');
INSERT INTO `clt_channels_users` VALUES ('522', '西瓜桥', 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', '35', '2018-04-01 15:16:36');
INSERT INTO `clt_channels_users` VALUES ('521', '西瓜桥', 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', '35', '2018-04-01 15:16:36');
INSERT INTO `clt_channels_users` VALUES ('519', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '35', '2018-04-01 15:16:15');
INSERT INTO `clt_channels_users` VALUES ('520', 'Frank', 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '35', '2018-04-01 15:16:32');
INSERT INTO `clt_channels_users` VALUES ('518', 'Frank', 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '35', '2018-04-01 15:08:22');
INSERT INTO `clt_channels_users` VALUES ('516', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '35', '2018-04-01 15:07:19');
INSERT INTO `clt_channels_users` VALUES ('517', 'Frank', 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '35', '2018-04-01 15:07:35');
INSERT INTO `clt_channels_users` VALUES ('514', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-04-01 14:51:19');
INSERT INTO `clt_channels_users` VALUES ('515', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-04-01 14:53:34');
INSERT INTO `clt_channels_users` VALUES ('512', 'wj', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-31 19:18:49');
INSERT INTO `clt_channels_users` VALUES ('513', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-04-01 14:22:51');
INSERT INTO `clt_channels_users` VALUES ('511', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-23 14:46:48');
INSERT INTO `clt_channels_users` VALUES ('510', '互动直播-老K', 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', '35', '2018-03-23 14:33:36');
INSERT INTO `clt_channels_users` VALUES ('509', '汪江', 'https://static.mudu.tv/index/avatar.png', '35', '2018-03-23 14:32:26');
INSERT INTO `clt_channels_users` VALUES ('551', 'aadf', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 11:37:50');
INSERT INTO `clt_channels_users` VALUES ('552', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 12:50:28');
INSERT INTO `clt_channels_users` VALUES ('553', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 12:52:47');
INSERT INTO `clt_channels_users` VALUES ('554', 'wj', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 12:58:19');
INSERT INTO `clt_channels_users` VALUES ('555', 'wj', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 12:58:42');
INSERT INTO `clt_channels_users` VALUES ('556', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 14:52:19');
INSERT INTO `clt_channels_users` VALUES ('557', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 14:54:56');
INSERT INTO `clt_channels_users` VALUES ('558', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 14:55:00');
INSERT INTO `clt_channels_users` VALUES ('559', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 14:55:27');
INSERT INTO `clt_channels_users` VALUES ('560', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 14:55:39');
INSERT INTO `clt_channels_users` VALUES ('561', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 14:56:10');
INSERT INTO `clt_channels_users` VALUES ('562', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 14:56:16');
INSERT INTO `clt_channels_users` VALUES ('563', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 15:04:10');
INSERT INTO `clt_channels_users` VALUES ('564', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 15:04:13');
INSERT INTO `clt_channels_users` VALUES ('565', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 15:05:06');
INSERT INTO `clt_channels_users` VALUES ('566', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 15:05:12');
INSERT INTO `clt_channels_users` VALUES ('567', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 15:15:52');
INSERT INTO `clt_channels_users` VALUES ('568', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 15:16:14');
INSERT INTO `clt_channels_users` VALUES ('569', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 16:05:43');
INSERT INTO `clt_channels_users` VALUES ('570', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 16:05:52');
INSERT INTO `clt_channels_users` VALUES ('571', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 16:06:44');
INSERT INTO `clt_channels_users` VALUES ('572', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-24 16:07:01');
INSERT INTO `clt_channels_users` VALUES ('573', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:34:33');
INSERT INTO `clt_channels_users` VALUES ('574', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:34:51');
INSERT INTO `clt_channels_users` VALUES ('575', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:35:11');
INSERT INTO `clt_channels_users` VALUES ('576', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:36:01');
INSERT INTO `clt_channels_users` VALUES ('577', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:38:43');
INSERT INTO `clt_channels_users` VALUES ('578', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:39:10');
INSERT INTO `clt_channels_users` VALUES ('579', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:40:15');
INSERT INTO `clt_channels_users` VALUES ('580', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:47:25');
INSERT INTO `clt_channels_users` VALUES ('581', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:47:37');
INSERT INTO `clt_channels_users` VALUES ('582', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 10:48:54');
INSERT INTO `clt_channels_users` VALUES ('583', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:03:52');
INSERT INTO `clt_channels_users` VALUES ('584', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:04:16');
INSERT INTO `clt_channels_users` VALUES ('585', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:04:23');
INSERT INTO `clt_channels_users` VALUES ('586', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:05:34');
INSERT INTO `clt_channels_users` VALUES ('587', 'ad\'f\'d', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:06:02');
INSERT INTO `clt_channels_users` VALUES ('588', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:06:49');
INSERT INTO `clt_channels_users` VALUES ('589', 'zql', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:08:06');
INSERT INTO `clt_channels_users` VALUES ('590', 'zql', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:08:11');
INSERT INTO `clt_channels_users` VALUES ('591', 'zql', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:08:27');
INSERT INTO `clt_channels_users` VALUES ('592', 'zql', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 11:12:47');
INSERT INTO `clt_channels_users` VALUES ('593', '游客121805', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 12:18:06');
INSERT INTO `clt_channels_users` VALUES ('594', '游客121813', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 12:18:15');
INSERT INTO `clt_channels_users` VALUES ('595', '游客011629', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 13:16:30');
INSERT INTO `clt_channels_users` VALUES ('596', '游客011632', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 13:16:34');
INSERT INTO `clt_channels_users` VALUES ('597', '游客024932', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 14:49:34');
INSERT INTO `clt_channels_users` VALUES ('598', '游客025115', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 14:51:16');
INSERT INTO `clt_channels_users` VALUES ('599', '游客025140', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 14:51:41');
INSERT INTO `clt_channels_users` VALUES ('600', '游客025946', '', '46', '2018-10-25 14:59:46');
INSERT INTO `clt_channels_users` VALUES ('601', '游客045320', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 16:53:21');
INSERT INTO `clt_channels_users` VALUES ('602', '游客045447', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 16:54:48');
INSERT INTO `clt_channels_users` VALUES ('603', '游客045525', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-25 16:55:29');
INSERT INTO `clt_channels_users` VALUES ('604', '游客103632', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 10:36:33');
INSERT INTO `clt_channels_users` VALUES ('605', '游客104030', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 10:40:31');
INSERT INTO `clt_channels_users` VALUES ('606', '游客110504', '', '46', '2018-10-26 11:05:04');
INSERT INTO `clt_channels_users` VALUES ('607', '游客110506', '', '46', '2018-10-26 11:05:06');
INSERT INTO `clt_channels_users` VALUES ('608', '游客110507', '', '46', '2018-10-26 11:05:07');
INSERT INTO `clt_channels_users` VALUES ('609', '游客110824', '', '46', '2018-10-26 11:08:24');
INSERT INTO `clt_channels_users` VALUES ('610', '', 'https://static.mudu.tv/index/avatar.png', '0', '2018-10-26 11:28:02');
INSERT INTO `clt_channels_users` VALUES ('611', '游客113307', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 11:33:08');
INSERT INTO `clt_channels_users` VALUES ('612', '上海网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 13:29:22');
INSERT INTO `clt_channels_users` VALUES ('613', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:30:23');
INSERT INTO `clt_channels_users` VALUES ('614', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:31:04');
INSERT INTO `clt_channels_users` VALUES ('615', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:31:41');
INSERT INTO `clt_channels_users` VALUES ('616', '内网IP网友', '', '46', '2018-10-26 15:31:55');
INSERT INTO `clt_channels_users` VALUES ('617', '内网IP网友', '', '46', '2018-10-26 15:32:01');
INSERT INTO `clt_channels_users` VALUES ('618', '内网IP网友', '', '46', '2018-10-26 15:32:10');
INSERT INTO `clt_channels_users` VALUES ('619', '内网IP网友', '', '46', '2018-10-26 15:32:11');
INSERT INTO `clt_channels_users` VALUES ('620', '内网IP网友', '', '46', '2018-10-26 15:32:12');
INSERT INTO `clt_channels_users` VALUES ('621', '内网IP网友', '', '46', '2018-10-26 15:32:13');
INSERT INTO `clt_channels_users` VALUES ('622', '内网IP网友', '', '46', '2018-10-26 15:32:15');
INSERT INTO `clt_channels_users` VALUES ('623', '内网IP网友', '', '46', '2018-10-26 15:32:15');
INSERT INTO `clt_channels_users` VALUES ('624', '内网IP网友', '', '46', '2018-10-26 15:32:17');
INSERT INTO `clt_channels_users` VALUES ('625', '内网IP网友', '', '46', '2018-10-26 15:32:17');
INSERT INTO `clt_channels_users` VALUES ('626', '内网IP网友', '', '46', '2018-10-26 15:32:17');
INSERT INTO `clt_channels_users` VALUES ('627', '内网IP网友', '', '46', '2018-10-26 15:32:41');
INSERT INTO `clt_channels_users` VALUES ('628', '内网IP网友', '', '46', '2018-10-26 15:33:13');
INSERT INTO `clt_channels_users` VALUES ('629', '内网IP网友', '', '46', '2018-10-26 15:33:20');
INSERT INTO `clt_channels_users` VALUES ('630', '内网IP网友', '', '46', '2018-10-26 15:34:02');
INSERT INTO `clt_channels_users` VALUES ('631', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:54:38');
INSERT INTO `clt_channels_users` VALUES ('632', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:55:10');
INSERT INTO `clt_channels_users` VALUES ('633', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:55:47');
INSERT INTO `clt_channels_users` VALUES ('634', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:55:49');
INSERT INTO `clt_channels_users` VALUES ('635', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 15:57:05');
INSERT INTO `clt_channels_users` VALUES ('636', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 16:00:09');
INSERT INTO `clt_channels_users` VALUES ('637', '上海网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 16:05:04');
INSERT INTO `clt_channels_users` VALUES ('638', '上海网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-26 16:05:35');
INSERT INTO `clt_channels_users` VALUES ('639', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-30 13:52:04');
INSERT INTO `clt_channels_users` VALUES ('640', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-30 16:45:13');
INSERT INTO `clt_channels_users` VALUES ('641', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-30 17:32:44');
INSERT INTO `clt_channels_users` VALUES ('642', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-30 17:32:59');
INSERT INTO `clt_channels_users` VALUES ('643', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-30 17:33:00');
INSERT INTO `clt_channels_users` VALUES ('644', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-30 17:33:02');
INSERT INTO `clt_channels_users` VALUES ('645', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-30 17:33:28');
INSERT INTO `clt_channels_users` VALUES ('646', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-31 11:15:56');
INSERT INTO `clt_channels_users` VALUES ('647', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-31 12:32:06');
INSERT INTO `clt_channels_users` VALUES ('648', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-31 12:36:33');
INSERT INTO `clt_channels_users` VALUES ('649', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-31 12:42:26');
INSERT INTO `clt_channels_users` VALUES ('650', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-10-31 16:31:35');
INSERT INTO `clt_channels_users` VALUES ('651', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-01 13:08:32');
INSERT INTO `clt_channels_users` VALUES ('652', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 10:21:39');
INSERT INTO `clt_channels_users` VALUES ('653', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 10:38:33');
INSERT INTO `clt_channels_users` VALUES ('654', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 10:51:23');
INSERT INTO `clt_channels_users` VALUES ('655', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 10:51:32');
INSERT INTO `clt_channels_users` VALUES ('656', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 10:51:36');
INSERT INTO `clt_channels_users` VALUES ('657', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 11:14:39');
INSERT INTO `clt_channels_users` VALUES ('658', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 11:14:48');
INSERT INTO `clt_channels_users` VALUES ('659', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 11:15:01');
INSERT INTO `clt_channels_users` VALUES ('660', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 11:15:32');
INSERT INTO `clt_channels_users` VALUES ('661', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 11:15:53');
INSERT INTO `clt_channels_users` VALUES ('662', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 13:50:58');
INSERT INTO `clt_channels_users` VALUES ('663', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 13:52:26');
INSERT INTO `clt_channels_users` VALUES ('664', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 13:52:44');
INSERT INTO `clt_channels_users` VALUES ('665', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-05 13:55:28');
INSERT INTO `clt_channels_users` VALUES ('666', '网友', 'https://static.mudu.tv/index/avatar.png', '0', '2018-11-05 14:04:55');
INSERT INTO `clt_channels_users` VALUES ('667', '网友', 'https://static.mudu.tv/index/avatar.png', '0', '2018-11-05 14:05:09');
INSERT INTO `clt_channels_users` VALUES ('668', '网友', 'https://static.mudu.tv/index/avatar.png', '0', '2018-11-05 14:05:26');
INSERT INTO `clt_channels_users` VALUES ('669', '网友', 'https://static.mudu.tv/index/avatar.png', '0', '2018-11-05 14:05:37');
INSERT INTO `clt_channels_users` VALUES ('670', '网友', 'https://static.mudu.tv/index/avatar.png', '0', '2018-11-05 14:05:55');
INSERT INTO `clt_channels_users` VALUES ('671', '', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-07 17:06:08');
INSERT INTO `clt_channels_users` VALUES ('672', 'q', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-07 17:06:20');
INSERT INTO `clt_channels_users` VALUES ('673', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-07 17:07:41');
INSERT INTO `clt_channels_users` VALUES ('674', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-08 10:07:27');
INSERT INTO `clt_channels_users` VALUES ('675', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-08 10:41:54');
INSERT INTO `clt_channels_users` VALUES ('676', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-08 11:07:53');
INSERT INTO `clt_channels_users` VALUES ('677', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-08 11:08:06');
INSERT INTO `clt_channels_users` VALUES ('678', 'wangjiang', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-08 11:08:20');
INSERT INTO `clt_channels_users` VALUES ('679', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 11:19:12');
INSERT INTO `clt_channels_users` VALUES ('680', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 11:19:20');
INSERT INTO `clt_channels_users` VALUES ('681', '网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 11:19:44');
INSERT INTO `clt_channels_users` VALUES ('682', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 11:28:55');
INSERT INTO `clt_channels_users` VALUES ('683', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 11:44:04');
INSERT INTO `clt_channels_users` VALUES ('684', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 12:54:43');
INSERT INTO `clt_channels_users` VALUES ('685', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 12:54:53');
INSERT INTO `clt_channels_users` VALUES ('686', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 12:56:29');
INSERT INTO `clt_channels_users` VALUES ('687', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 12:56:40');
INSERT INTO `clt_channels_users` VALUES ('688', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 12:57:07');
INSERT INTO `clt_channels_users` VALUES ('689', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 12:58:52');
INSERT INTO `clt_channels_users` VALUES ('690', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 12:59:45');
INSERT INTO `clt_channels_users` VALUES ('691', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:00:01');
INSERT INTO `clt_channels_users` VALUES ('692', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:00:07');
INSERT INTO `clt_channels_users` VALUES ('693', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:00:43');
INSERT INTO `clt_channels_users` VALUES ('694', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:00:53');
INSERT INTO `clt_channels_users` VALUES ('695', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:01:18');
INSERT INTO `clt_channels_users` VALUES ('696', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:02:10');
INSERT INTO `clt_channels_users` VALUES ('697', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:03:43');
INSERT INTO `clt_channels_users` VALUES ('698', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:04:08');
INSERT INTO `clt_channels_users` VALUES ('699', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:04:22');
INSERT INTO `clt_channels_users` VALUES ('700', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:06:22');
INSERT INTO `clt_channels_users` VALUES ('701', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:06:40');
INSERT INTO `clt_channels_users` VALUES ('702', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:18:26');
INSERT INTO `clt_channels_users` VALUES ('703', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:22:53');
INSERT INTO `clt_channels_users` VALUES ('704', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:57:34');
INSERT INTO `clt_channels_users` VALUES ('705', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:57:56');
INSERT INTO `clt_channels_users` VALUES ('706', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:58:14');
INSERT INTO `clt_channels_users` VALUES ('707', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:59:16');
INSERT INTO `clt_channels_users` VALUES ('708', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 13:59:37');
INSERT INTO `clt_channels_users` VALUES ('709', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:08:01');
INSERT INTO `clt_channels_users` VALUES ('710', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:08:28');
INSERT INTO `clt_channels_users` VALUES ('711', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:09:35');
INSERT INTO `clt_channels_users` VALUES ('712', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:10:53');
INSERT INTO `clt_channels_users` VALUES ('713', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:11:32');
INSERT INTO `clt_channels_users` VALUES ('714', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:12:23');
INSERT INTO `clt_channels_users` VALUES ('715', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:12:27');
INSERT INTO `clt_channels_users` VALUES ('716', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:12:49');
INSERT INTO `clt_channels_users` VALUES ('717', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:13:11');
INSERT INTO `clt_channels_users` VALUES ('718', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:13:58');
INSERT INTO `clt_channels_users` VALUES ('719', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:14:27');
INSERT INTO `clt_channels_users` VALUES ('720', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:14:53');
INSERT INTO `clt_channels_users` VALUES ('721', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:15:14');
INSERT INTO `clt_channels_users` VALUES ('722', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:17:31');
INSERT INTO `clt_channels_users` VALUES ('723', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:18:19');
INSERT INTO `clt_channels_users` VALUES ('724', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:18:40');
INSERT INTO `clt_channels_users` VALUES ('725', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:19:24');
INSERT INTO `clt_channels_users` VALUES ('726', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:21:09');
INSERT INTO `clt_channels_users` VALUES ('727', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:22:01');
INSERT INTO `clt_channels_users` VALUES ('728', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:22:10');
INSERT INTO `clt_channels_users` VALUES ('729', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:23:18');
INSERT INTO `clt_channels_users` VALUES ('730', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:26:12');
INSERT INTO `clt_channels_users` VALUES ('731', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:26:19');
INSERT INTO `clt_channels_users` VALUES ('732', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:26:29');
INSERT INTO `clt_channels_users` VALUES ('733', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:26:47');
INSERT INTO `clt_channels_users` VALUES ('734', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:26:58');
INSERT INTO `clt_channels_users` VALUES ('735', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:32:37');
INSERT INTO `clt_channels_users` VALUES ('736', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:33:06');
INSERT INTO `clt_channels_users` VALUES ('737', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:33:34');
INSERT INTO `clt_channels_users` VALUES ('738', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:33:43');
INSERT INTO `clt_channels_users` VALUES ('739', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:33:46');
INSERT INTO `clt_channels_users` VALUES ('740', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:34:06');
INSERT INTO `clt_channels_users` VALUES ('741', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:34:16');
INSERT INTO `clt_channels_users` VALUES ('742', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:36:08');
INSERT INTO `clt_channels_users` VALUES ('743', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:36:18');
INSERT INTO `clt_channels_users` VALUES ('744', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:37:43');
INSERT INTO `clt_channels_users` VALUES ('745', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:39:01');
INSERT INTO `clt_channels_users` VALUES ('746', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:39:23');
INSERT INTO `clt_channels_users` VALUES ('747', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:40:35');
INSERT INTO `clt_channels_users` VALUES ('748', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:40:46');
INSERT INTO `clt_channels_users` VALUES ('749', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:41:13');
INSERT INTO `clt_channels_users` VALUES ('750', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:42:16');
INSERT INTO `clt_channels_users` VALUES ('751', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:42:26');
INSERT INTO `clt_channels_users` VALUES ('752', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:44:21');
INSERT INTO `clt_channels_users` VALUES ('753', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 15:45:14');
INSERT INTO `clt_channels_users` VALUES ('754', '内网IP网友', 'https://static.mudu.tv/index/avatar.png', '46', '2018-11-09 16:07:09');

-- ----------------------------
-- Table structure for `clt_channelwxusers`
-- ----------------------------
DROP TABLE IF EXISTS `clt_channelwxusers`;
CREATE TABLE `clt_channelwxusers` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '频道微信用户表id',
  `cid` int(11) NOT NULL COMMENT '直播频道id',
  ...
  `datatime` varchar(255) NOT NULL COMMENT '手机微信授权用户登录时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=264 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_channelwxusers
-- ----------------------------
INSERT INTO `clt_channelwxusers` VALUES ('231', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:31:55');
INSERT INTO `clt_channelwxusers` VALUES ('232', '35', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', '西瓜桥', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', null, 'oSiyOwBnNqIiM8CxI3huobLRo5QA', '2018-03-22 04:33:03');
INSERT INTO `clt_channelwxusers` VALUES ('233', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:34:25');
INSERT INTO `clt_channelwxusers` VALUES ('234', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:35:23');
INSERT INTO `clt_channelwxusers` VALUES ('235', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:35:34');
INSERT INTO `clt_channelwxusers` VALUES ('236', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:35:46');
INSERT INTO `clt_channelwxusers` VALUES ('237', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:36:31');
INSERT INTO `clt_channelwxusers` VALUES ('238', '35', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', '西瓜桥', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', null, 'oSiyOwBnNqIiM8CxI3huobLRo5QA', '2018-03-22 04:37:05');
INSERT INTO `clt_channelwxusers` VALUES ('239', '35', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', '西瓜桥', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', null, 'oSiyOwBnNqIiM8CxI3huobLRo5QA', '2018-03-22 04:37:18');
INSERT INTO `clt_channelwxusers` VALUES ('240', '36', 'okRTqvvFqachnK-6m9XqbDAz5oXA', '空空空空', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJeOZwicjtKoFOD7jHNibDu2d7zIic5cPMNLN2zBwib01Tpm700gIZ1XOJ5aAzo7WyqdXicZyicgrZiaGxzw/132', null, 'oSiyOwGM_kXJ2FwTBHpyDLDDAD8c', '2018-03-22 04:37:32');
INSERT INTO `clt_channelwxusers` VALUES ('241', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:42:01');
INSERT INTO `clt_channelwxusers` VALUES ('242', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:44:16');
INSERT INTO `clt_channelwxusers` VALUES ('243', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:48:04');
INSERT INTO `clt_channelwxusers` VALUES ('263', '43', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', '西瓜桥', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3pRCOCaxw2olYYR0wibCtCCQ/132', null, 'oSiyOwBnNqIiM8CxI3huobLRo5QA', '2018-08-22 01:22:29');
INSERT INTO `clt_channelwxusers` VALUES ('262', '43', 'okRTqvvR1SET8Xt44phHvIo6dNXs', '╬═☆、燕子★、', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/pgD4zrNkXtRWvr8hxpSyrf26uzfvfiaR46vTGlugeLHsID5ZJ2IVVv2XoueUvXOFkVXaic36XmRSLHn3TW2Lylyg/132', null, 'oSiyOwF3LCgfncRyzCTD0tvKIKtE', '2018-08-22 01:22:04');
INSERT INTO `clt_channelwxusers` VALUES ('261', '41', 'okRTqvl3zeKRtxIKLZrgHNVJJ6ww', '王方', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83ericMPp2Cq4owha1JJTI4pV16rWN6iaSu0dT32RSReuffKVTibCF46mb8zJ3O4hWicM5vgUoa3dsULh9w/132', null, 'oSiyOwNS_fluHLPAy_fKhx7fymkk', '2018-07-02 04:52:30');
INSERT INTO `clt_channelwxusers` VALUES ('260', '35', 'okRTqvvt9sAqHsu1sggFvyZaXJ-8', '互动直播-老K', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', null, 'oSiyOwPnhNTia-SJtea-0Ggffqhw', '2018-04-01 03:19:57');
INSERT INTO `clt_channelwxusers` VALUES ('259', '35', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', '西瓜桥', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', null, 'oSiyOwBnNqIiM8CxI3huobLRo5QA', '2018-04-01 03:19:02');
INSERT INTO `clt_channelwxusers` VALUES ('258', '35', 'okRTqviXTlp_kbc2VuQlfw99-FXY', 'Frank', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', null, 'oSiyOwGt5RnJnA65YqJ9CKj_yb9U', '2018-04-01 03:18:57');
INSERT INTO `clt_channelwxusers` VALUES ('257', '35', 'okRTqviXTlp_kbc2VuQlfw99-FXY', 'Frank', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', null, 'oSiyOwGt5RnJnA65YqJ9CKj_yb9U', '2018-04-01 03:18:57');
INSERT INTO `clt_channelwxusers` VALUES ('256', '35', 'okRTqvvt9sAqHsu1sggFvyZaXJ-8', '互动直播-老K', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', null, 'oSiyOwPnhNTia-SJtea-0Ggffqhw', '2018-04-01 03:18:48');
INSERT INTO `clt_channelwxusers` VALUES ('255', '35', 'okRTqvvt9sAqHsu1sggFvyZaXJ-8', '互动直播-老K', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', null, 'oSiyOwPnhNTia-SJtea-0Ggffqhw', '2018-04-01 03:18:48');
INSERT INTO `clt_channelwxusers` VALUES ('254', '35', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', '西瓜桥', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', null, 'oSiyOwBnNqIiM8CxI3huobLRo5QA', '2018-04-01 03:16:36');
INSERT INTO `clt_channelwxusers` VALUES ('253', '35', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', '西瓜桥', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', null, 'oSiyOwBnNqIiM8CxI3huobLRo5QA', '2018-04-01 03:16:36');
INSERT INTO `clt_channelwxusers` VALUES ('252', '35', 'okRTqviXTlp_kbc2VuQlfw99-FXY', 'Frank', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', null, 'oSiyOwGt5RnJnA65YqJ9CKj_yb9U', '2018-04-01 03:16:32');
INSERT INTO `clt_channelwxusers` VALUES ('251', '35', 'okRTqviXTlp_kbc2VuQlfw99-FXY', 'Frank', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', null, 'oSiyOwGt5RnJnA65YqJ9CKj_yb9U', '2018-04-01 03:08:22');
INSERT INTO `clt_channelwxusers` VALUES ('250', '35', 'okRTqviXTlp_kbc2VuQlfw99-FXY', 'Frank', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', null, 'oSiyOwGt5RnJnA65YqJ9CKj_yb9U', '2018-04-01 03:07:35');
INSERT INTO `clt_channelwxusers` VALUES ('249', '35', 'okRTqvvt9sAqHsu1sggFvyZaXJ-8', '互动直播-老K', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', null, 'oSiyOwPnhNTia-SJtea-0Ggffqhw', '2018-03-23 02:33:36');
INSERT INTO `clt_channelwxusers` VALUES ('248', '35', 'okRTqvvt9sAqHsu1sggFvyZaXJ-8', '互动直播-老K', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', null, 'oSiyOwPnhNTia-SJtea-0Ggffqhw', '2018-03-23 02:29:36');
INSERT INTO `clt_channelwxusers` VALUES ('247', '35', 'okRTqvvt9sAqHsu1sggFvyZaXJ-8', '互动直播-老K', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', null, 'oSiyOwPnhNTia-SJtea-0Ggffqhw', '2018-03-23 02:29:36');
INSERT INTO `clt_channelwxusers` VALUES ('246', '36', 'okRTqviXTlp_kbc2VuQlfw99-FXY', 'Frank', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', null, 'oSiyOwGt5RnJnA65YqJ9CKj_yb9U', '2018-03-22 04:48:51');
INSERT INTO `clt_channelwxusers` VALUES ('245', '36', 'okRTqviXTlp_kbc2VuQlfw99-FXY', 'Frank', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', null, 'oSiyOwGt5RnJnA65YqJ9CKj_yb9U', '2018-03-22 04:48:51');
INSERT INTO `clt_channelwxusers` VALUES ('244', '36', 'okRTqvgVwl4Sw7oCCn9D6fxOMO6A', '平底郭', null, null, null, null, 'http://thirdwx.qlogo.cn/mmopen/vi_32/vwlwvI0g4SAO5ArhqkMk6T9nIUd9OoqJzz0BpicT2DibW2sicKQxZgYY1kXEAlZw3eNSpClichiaq9iciaH5jU5NY1ibyg/132', null, 'oSiyOwPEd9ngerIaFphRRplhOhz4', '2018-03-22 04:48:17');

-- ----------------------------
-- Table structure for `clt_ch_we_cms`
-- ----------------------------
DROP TABLE IF EXISTS `clt_ch_we_cms`;
CREATE TABLE `clt_ch_we_cms` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `channels_id` int(8) NOT NULL DEFAULT '0' COMMENT '频道id',
  `webex_id` int(8) NOT NULL DEFAULT '0' COMMENT 'webex账号id',
  `tms_id` int(8) NOT NULL DEFAULT '0' COMMENT 'tms账号id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_ch_we_cms
-- ----------------------------
INSERT INTO `clt_ch_we_cms` VALUES ('1', '1', '1', '1');

-- ----------------------------
-- Table structure for `clt_code_view`
-- ----------------------------
DROP TABLE IF EXISTS `clt_code_view`;
CREATE TABLE `clt_code_view` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '验证码观看主键id',
  `pid` int(11) NOT NULL COMMENT '绑定直播频道id',
  `code_title` varchar(255) DEFAULT NULL COMMENT '直播提示文字',
  `codevar` varchar(255) DEFAULT NULL COMMENT '直播自定义验证码',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_code_view
-- ----------------------------
...
-- ----------------------------
-- Table structure for `clt_idcard`
-- ----------------------------
DROP TABLE IF EXISTS `clt_idcard`;
CREATE TABLE `clt_idcard` (
...
-- ----------------------------
-- Records of clt_idcard
-- ----------------------------
INSERT INTO `clt_idcard` VALUES ('1', '身份证', '0');
INSERT INTO `clt_idcard` VALUES ('2', '护照', '0');

-- ----------------------------
-- Table structure for `clt_language`
-- ----------------------------
DROP TABLE IF EXISTS `clt_language`;
CREATE TABLE `clt_language` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of clt_language
-- ----------------------------
INSERT INTO `clt_language` VALUES ('1', '中文', '1', '0', '', '0', '1523426542', '0', '0', '0', '1');
INSERT INTO `clt_language` VALUES ('2', '英文', '1', '0', '', '0', '1523426746', '0', '0', '0', '1');
...
-- ----------------------------
-- Table structure for `clt_order_type`
-- ----------------------------
DROP TABLE IF EXISTS `clt_order_type`;
CREATE TABLE `clt_order_type` (
  `id` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT '//订单类型编号',
...
-- ----------------------------
-- Records of clt_order_type
-- ----------------------------
INSERT INTO `clt_order_type` VALUES ('1', '音乐考级', '0');
INSERT INTO `clt_order_type` VALUES ('3', '比赛报名', '0');
...
-- Records of clt_page
-- ----------------------------
INSERT INTO `clt_page` VALUES ('19', '乐器等级列表', '', '', '0', '0', '0', '', '0', '0', '0', '0', '');
...
CREATE TABLE `clt_pay_order` (
  ...
  `title` text NOT NULL COMMENT '//订单标题',
  `tktime` int(10) DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `clt_pay_order` VALUES ('1', '1', '2018013154565657', null, '0.02', '1', '1517390310', '1517390320', 's:911:\"{\"data\":{\"name\":\"\\u738b\\u664b\",\"uid\":1,\"sex\":\"1\",\"birthday\":\"2018\\u5e7401\\u670831\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"18721667531\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180131\\/1517390282.jpeg\",\"email\":\"972270516@qq.com\",\"province\":\"2\",\"city\":\"52\",\"district\":\"500\",\"address\":\"\\u6d4b\\u8bd5\",\"zipcode\":\"121211\",\"idtpl\":\"142631199302011719\",\"school\":\"\\u6d4b\\u8bd5\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.baidu.com\",\"sings\":\"\\u6d4b\\u8bd5\",\"order_no\":\"2018013154565657\",\"createtime\":1517390310},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('2', '2', '2018013198541011', null, '0.02', '1', '1517391115', '1517391124', 's:913:\"{\"data\":{\"name\":\"frank\",\"uid\":2,\"sex\":\"1\",\"birthday\":\"2018\\u5e7401\\u670831\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"18616696490\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180131\\/1517391076.jpeg\",\"email\":\"ql.zhang@meetuuu.com\",\"province\":\"6\",\"city\":\"78\",\"district\":\"712\",\"address\":\"fkJj\",\"zipcode\":\"200433\",\"idtpl\":\"310101198811150514\",\"school\":\"cjjfh\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.baidu.com\",\"sings\":\"djdnxbb,hdjfhdbj,jdhdbdb,jdhdbbc\",\"order_no\":\"2018013198541011\",\"createtime\":1517391115},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('3', '4', '2018013148101559', null, '0.02', '1', '1517391744', '1517391762', 's:883:\"{\"data\":{\"name\":\"hsjj\",\"uid\":4,\"sex\":\"1\",\"birthday\":\"2018\\u5e7401\\u670831\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"13584596939\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180131\\/1517391653.jpeg\",\"email\":\"1234566@qq.com\",\"province\":\"4\",\"city\":\"56\",\"district\":\"551\",\"address\":\"dhjkj\",\"zipcode\":\"123123\",\"idtpl\":\"123456132154631245\",\"school\":\"djjhsh\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.djjdjj.com\",\"sings\":\"sjjdjj\",\"order_no\":\"2018013148101559\",\"createtime\":1517391744},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('4', '3', '2018013148995651', null, '0.02', '1', '1517391840', '1517391848', 's:936:\"{\"data\":{\"name\":\"\\u6c6a\\u4e4b\\u6c5f\",\"uid\":3,\"sex\":\"1\",\"birthday\":\"1993\\u5e7401\\u670831\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"18721887229\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180131\\/1517391745.jpeg\",\"email\":\"1634259995@qq.com\",\"province\":\"5\",\"city\":\"66\",\"district\":\"633\",\"address\":\"\\u4e0d\\u4e0d\\u4e0d\\u4e0d\",\"zipcode\":\"163423\",\"idtpl\":\"420922199510070014\",\"school\":\"\\u4e0d\\u5305\\u542b\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.baidu.com\",\"sings\":\"\\u62dc\\u62dc\",\"order_no\":\"2018013148995651\",\"createtime\":1517391840},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('5', '1', '2018013199481019', null, '0.02', '1', '1517394764', '1517394770', 's:837:\"{\"data\":{\"name\":\"\\u738b\\u664b\",\"uid\":1,\"birthday\":\"2018\\u5e7401\\u670831\\u65e5 \",\"country\":\"2\",\"tel\":\"18721667531\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180131\\/1517394734.jpeg\",\"email\":\"972270516@qq.com\",\"address\":\"\\u5730\\u5740\",\"zipcode\":\"121121\",\"idtpl\":\"54544554545\",\"school\":\"\\u54c8\\u6bd4\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.baidu.com\",\"sings\":\"\\u54c8\\u54c8\",\"order_no\":\"2018013199481019\",\"createtime\":1517394764},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('6', '4', '2018013110299505', null, '0.02', '1', '1517399231', '1517399239', 's:936:\"{\"data\":{\"name\":\"\\u5f20\\u5927\\u73ed\",\"uid\":4,\"sex\":\"1\",\"birthday\":\"2018\\u5e7404\\u670828\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"15692185366\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180131\\/1517398946.jpeg\",\"email\":\"q@qq.com\",\"province\":\"2\",\"city\":\"52\",\"district\":\"504\",\"address\":\"\\u5929\\u5b89\\u95e8\",\"zipcode\":\"100022\",\"idtpl\":\"310115198002074935\",\"school\":\"\\u5ef6\\u957f\\u8def220\\u53f7\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.baidu.com\",\"sings\":\"\\u5927\\u5408\\u5531\",\"order_no\":\"2018013110299505\",\"createtime\":1517399231},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('7', '7', '2018020110110054', null, '0.02', '1', '1517469646', '1517469655', 's:978:\"{\"data\":{\"name\":\"\\u4e01\\u4e01\",\"uid\":7,\"birthday\":\"2011\\u5e7402\\u670801\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"13801811422\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180201\\/1517469506.jpeg\",\"email\":\"1139434466@qq.com\",\"province\":\"25\",\"city\":\"321\",\"district\":\"2706\",\"address\":\"\\u77f3\\u9f99\\u8def345\\u5f04\",\"zipcode\":\"200080\",\"idtpl\":\"310109197802160020\",\"school\":\"\\u4e0a\\u6d77\\u97f3\\u534f\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"\\u63a5https:\\/\\/m.v.qq.com\\/page\\/n\\/0\\/w\\/n0523o235hw.html\",\"sings\":\"\\u604b\\u7231\",\"order_no\":\"2018020110110054\",\"createtime\":1517469646},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('8', '16', '2018020252551015', null, '0.02', '1', '1517556356', '1517556365', 's:1036:\"{\"data\":{\"name\":\"\\u5b59\\u742a\\u7426\",\"uid\":16,\"sex\":\"1\",\"birthday\":\"1995\\u5e7405\\u670808\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"17621010325\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180202\\/1517556310.png\",\"email\":\"1183823973@qq.com\",\"province\":\"23\",\"city\":\"310\",\"district\":\"2585\",\"address\":\"\\u6cb3\\u6d25\\u5e02\\u6a0a\\u6751\\u9547\\u5e38\\u597d\\u5821\\u6751\",\"zipcode\":\"043300\",\"cardid\":\"1\",\"idtpl\":\"14270319950325061X\",\"school\":\"\\u6cb3\\u6d25\\u5e02\\u6a0a\\u6751\\u4e2d\\u5b66\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.wjssb.com\",\"sings\":\"\\u4e0d\\u77e5\\u9053\\u5565\\u73a9\\u610f\",\"order_no\":\"2018020252551015\",\"createtime\":1517556356},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('9', '17', '2018020210153100', null, '0.02', '1', '1517559678', '1517559684', 's:946:\"{\"data\":{\"name\":\"\\u6a0a\\u5927\\u5927\",\"uid\":17,\"sex\":\"1\",\"birthday\":\"2017\\u5e7402\\u670802\\u65e5 \",\"country\":\"1\",\"nation\":\"5\",\"tel\":\"18801881881\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180202\\/1517559640.png\",\"email\":\"316433@qq.com\",\"province\":\"25\",\"city\":\"321\",\"district\":\"2706\",\"address\":\"\\u67d0\\u87ba\\u6bcd\",\"zipcode\":\"200081\",\"cardid\":\"1\",\"idtpl\":\"31011519827676491X\",\"school\":\"\\u5c0f\\u5c0f\\u5b66\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.sjs.com\",\"sings\":\"\\u7ec3\\u4e60\\u66f2\",\"order_no\":\"2018020210153100\",\"createtime\":1517559678},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('10', '18', '2018020297989955', null, '0.02', '0', '1517559962', '0', 's:972:\"{\"data\":{\"name\":\"\\u963f\\u8d1d\",\"uid\":18,\"sex\":\"0\",\"birthday\":\"2018\\u5e7402\\u670802\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"18916530713\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180202\\/1517559899.jpeg\",\"email\":\"shengli7064@163.com\",\"province\":\"25\",\"city\":\"321\",\"district\":\"2712\",\"address\":\"\\u5e7f\\u4e2d\\u8def525\\u5f042\\u53f7\",\"zipcode\":\"200083\",\"cardid\":\"1\",\"idtpl\":\"310109200507134027\",\"school\":\"\\u534e\\u80b2\\u4e2d\\u5b66\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"AA\",\"sings\":\"\\u6211\\u7231\\u4f60\\u4e2d\\u56fd\",\"order_no\":\"2018020297989955\",\"createtime\":1517559962},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('11', '6', '2018020299995010', null, '0.02', '0', '1517560764', '0', 's:1010:\"{\"data\":{\"name\":\"\\u674e\\u5609\\u6b23\",\"uid\":6,\"sex\":\"0\",\"birthday\":\"1995\\u5e7401\\u670805\\u65e5 \",\"country\":\"1\",\"nation\":\"1\",\"tel\":\"13621998052\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180202\\/1517560681.jpeg\",\"email\":\"hasomeyaeka@sisina.com\",\"province\":\"25\",\"city\":\"321\",\"district\":\"2712\",\"address\":\"\\u65b0\\u5609\\u8def1\\u5f042\\u53f72602\",\"zipcode\":\"200080\",\"cardid\":\"1\",\"idtpl\":\"31010919950105002X\",\"school\":\"\\u77f3\\u9f99\\u8def345\\u5f0428\\u53f7D\\u680b\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"http:\\/\\/web.tencent.com\",\"sings\":\"\\u51a5\\u60f3\\u66f2\",\"order_no\":\"2018020299995010\",\"createtime\":1517560764},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');
INSERT INTO `clt_pay_order` VALUES ('12', '19', '2018020210197985', null, '0.02', '1', '1517565790', '1517565802', 's:943:\"{\"data\":{\"name\":\"\\u80e1\\u5146\\u660e\",\"uid\":19,\"sex\":\"1\",\"birthday\":\"2018\\u5e7402\\u670802\\u65e5 \",\"country\":\"1\",\"nation\":\"2\",\"tel\":\"13918937321\",\"thumb\":\"\\/public\\/uploads\\/photo\\/20180202\\/1517565706.jpeg\",\"email\":\"2530467067@qq.com\",\"province\":\"25\",\"city\":\"321\",\"district\":\"2712\",\"address\":\"\\u7eaa\\u5ff5\\u8def555\",\"zipcode\":\"200343\",\"cardid\":\"1\",\"idtpl\":\"310109198008084812\",\"school\":\"\\u5e02\\u4e2d\\u5fc3\",\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"videourl\":\"www.qq.com\",\"sings\":\"cheng du\",\"order_no\":\"2018020210197985\",\"createtime\":1517565790},\"more\":{\"costid\":1,\"costtitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a|\\u94a2\\u7434|\\u4e00\\u7ea7|\\u5c11\\u5e74\\u7ec4\",\"gameid\":1,\"gametitle\":\"\\u5c0f\\u661f\\u7403\\u97f3\\u60a6\\u4f1a\",\"yqid\":1,\"yqtitle\":\"\\u94a2\\u7434\",\"teamid\":1,\"teamtitle\":\"\\u5c11\\u5e74\\u7ec4\",\"levelid\":1,\"leveltitle\":\"\\u4e00\\u7ea7\",\"cost\":\"0.01\",\"service_cost\":\"0.01\"}}\";', '0.01', '0.00', '0.01', '0.00', '0', '3', '小星球音悦会报名比赛订单', '0');

-- ----------------------------
-- Table structure for `clt_pexip_list`
-- ----------------------------
DROP TABLE IF EXISTS `clt_pexip_list`;
CREATE TABLE `clt_pexip_list` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `pexip_name` varchar(60) NOT NULL DEFAULT '' COMMENT '账号',
  `pexip_pwd` varchar(100) NOT NULL DEFAULT '' COMMENT '密码',
  `conference_alias` varchar(100) NOT NULL DEFAULT '' COMMENT '别名',
  `system_location` varchar(100) NOT NULL DEFAULT '' COMMENT '系统位置',
  `meeting_name` varchar(100) NOT NULL DEFAULT '' COMMENT '会议室名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_pexip_list
-- ----------------------------
...
-- ----------------------------
-- Table structure for `clt_tms_list`
-- ----------------------------
DROP TABLE IF EXISTS `clt_tms_list`;
CREATE TABLE `clt_tms_list` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `tms_name` varchar(255) NOT NULL DEFAULT '' COMMENT '账号',
  `tms_password` varchar(255) NOT NULL DEFAULT '' COMMENT '密码',
  `userid` int(8) NOT NULL DEFAULT '0' COMMENT '用户id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_tms_list
-- ----------------------------
INSERT INTO `clt_tms_list` VALUES ('1', 'ketiancloud\\api_admin', 'P@ss1234', '1');
...
-- ----------------------------
INSERT INTO `clt_users` VALUES ('1', '', '', null, '1', '0', '1517389898', '1517583589', '', '', '', '0', 'phone_weixin', 'okRTqvpPRPq2WXM_1kXSAcQSZx2g', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLGJZibGPRS1U7OSRyFC0tu9peVeVvVathrlILVF3IuAsribOdK2qKyDg5grTazv7gZ7icNVd452f50A/132', '0', '0', '0', '0', '。', '1', '0', '8f18b32ec4bd73916597309baac397e3', '', 'hide');
INSERT INTO `clt_users` VALUES ('2', '', '', null, '0', '0', '1517390451', '0', '', '', '', '0', 'phone_weixin', 'okRTqviXTlp_kbc2VuQlfw99-FXY', null, 'http://wx.qlogo.cn/mmopen/vi_32/BZ0iakAttMwIZJROwBx3d1oNh3icF4TJA3S3c6TUSCwgGlqjTpBibUKvGD1nOCv5JZvjfJJrLSVFCGQ0NmkZrndtA/132', '0', '0', '0', '0', 'Frank', '1', '0', 'c11add360991dd992d639b91c39d98a7', '', 'hide');
INSERT INTO `clt_users` VALUES ('3', '', '', null, '1', '0', '1517390882', '1517391652', '', '', '', '0', 'phone_weixin', 'okRTqvqRF0wqAu5zb6bshEJ5H48c', null, 'http://wx.qlogo.cn/mmopen/vi_32/PiajxSqBRaELKKVDMUia0QkgSat7zxvXWDZaK5qu1oLmDia84FHZonzLDFrEywGia1g3a6rfbg28xytjAW3pqoA58g/132', '0', '0', '0', '0', '西瓜桥', '1', '0', 'f131c400131645a90f37fbf976c414d8', '', 'hide');
INSERT INTO `clt_users` VALUES ('4', '', '', null, '1', '0', '1517398832', '0', '', '', '', '0', 'phone_weixin', 'okRTqvvt9sAqHsu1sggFvyZaXJ-8', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJMWl3EYJ7sNU1oCuQ1tZia9NWjXgYo84Chgde9YZ3XR4AZXW7Y70qiauXuKOQDtnzpzcicrqmTE7OsA/132', '0', '0', '0', '0', '老K', '1', '0', 'de96e885933ccc92fcc00105f917c4b6', '', 'hide');
INSERT INTO `clt_users` VALUES ('5', '', '', null, '1', '0', '1517408387', '0', '', '', '', '0', 'phone_weixin', 'okRTqvvFqachnK-6m9XqbDAz5oXA', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJeOZwicjtKoFOD7jHNibDu2d7zIic5cPMNLN2zBwib01Tpm700gIZ1XOJ5aAzo7WyqdXicZyicgrZiaGxzw/132', '0', '0', '0', '0', '空空空空', '1', '0', '275a4d71abf8a566d2ddb245b117440b', '', 'hide');
INSERT INTO `clt_users` VALUES ('6', '', '', null, '1', '0', '1517465946', '1517560416', '', '', '', '0', 'phone_weixin', 'okRTqvjuPXnNC9SiRUh_pKfSKOSQ', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJjfiaEtpxoTqTsKEvdj4jc0HG5fibYjSbtSGWK2jC3xhOBbMdW2aR4GTN9XZLyrDfVLjL5v71Lib3dg/132', '0', '0', '0', '0', 'Cassi', '1', '0', '954f6a712f93634a52161b13cc2a9c6b', '', 'hide');
INSERT INTO `clt_users` VALUES ('7', '', '', null, '2', '0', '1517466122', '1517708018', '', '', '', '0', 'phone_weixin', 'okRTqvtqvaKPw-mDiy8DZM8SX1qc', null, 'http://wx.qlogo.cn/mmopen/vi_32/PiajxSqBRaEILepo3cArl1Lf1brgFkoW4tUBjZB4zxlhJt5gVic47yq5gdtsrUib64MyiaicmwUV3SbutwhE4edLufg/132', '0', '0', '0', '0', '丁一蕾', '1', '0', '78c92e41225a85bb191b3f4dae5fbe6f', '', 'hide');
INSERT INTO `clt_users` VALUES ('8', '', '', null, '1', '0', '1517471737', '1517561404', '', '', '', '0', 'phone_weixin', 'okRTqvuuHFPVG5OO_Xb3b7LO259w', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLqIjUjibiapA2oDKZH8dYDpLvjLBqaF6zKd1EIyJtdqrvzHDN85UHRpvxc8hxXUsD4Vias5Mbhr8CGg/132', '0', '0', '0', '0', '嘉嘉', '1', '0', 'bbe178409b4bd5138c40ca8a3dd77ae1', '', 'hide');
INSERT INTO `clt_users` VALUES ('9', '', '', null, '0', '0', '1517483345', '0', '', '', '', '0', 'phone_weixin', 'okRTqvpLcVxYG72txmLiHDDLy-x4', null, 'http://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83eqJwqrmPblDqgNt6AbXl78n6MYkvs0NbUdEMz24iaqxPw6KmewBvtQGLQXn01TuC4z64pZCprzlrzA/132', '0', '0', '0', '0', '郭强辉', '1', '0', '7fe785ee15c5b097d3faaed61e15121d', '', 'hide');
INSERT INTO `clt_users` VALUES ('10', '', '', null, '0', '0', '1517489101', '0', '', '', '', '0', 'phone_weixin', 'okRTqvqeeKrHg77VXGAFO6mDc-Rk', null, 'http://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83epF3ibuJ31CLWtXmLmIrlqefShG3UpJbaloNic7vjDGcADdfbtibGibF9XXChk8v3VqWwnMDKsc077x6Q/132', '0', '0', '0', '0', '闲来镜界', '1', '0', 'e0881816412daf45be1c55cb2131cb0f', '', 'hide');
INSERT INTO `clt_users` VALUES ('11', '', '', null, '1', '0', '1517493824', '0', '', '', '', '0', 'phone_weixin', 'okRTqvrECie-X9-YmDsZSraV5kzo', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTK3Hicicxyd7dL4AOPIY1vtMIUm7cWPvgicThDbDkr7IsZVzFZt2OtU6tkUfITkKmHnYNUeJts1rvic0Q/132', '0', '0', '0', '0', 'Steven Zhang', '1', '0', '39cd161c34a14604df5fce0243e3e1db', '', 'hide');
INSERT INTO `clt_users` VALUES ('12', '', '', null, '0', '0', '1517536504', '0', '', '', '', '0', 'phone_weixin', 'okRTqvqVrDIEPanBJhMW5Hnusyvc', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJibbS6AvrsQeFVHMicFRKD9EpfFEkiciaOg4ZAekLIsg95bZsZicYhAQJS9Q38tQu6fjBfQx5oVf12ejA/132', '0', '0', '0', '0', '水木', '1', '0', 'bea6c863ff44ba0de1f656e6edf73ee6', '', 'hide');
INSERT INTO `clt_users` VALUES ('13', '', '', null, '1', '0', '1517553308', '0', '', '', '', '0', 'phone_weixin', 'okRTqvsCRWfWOciclXiWPgMHAiQs', null, 'http://wx.qlogo.cn/mmopen/vi_32/24Qy0A8pxeicC8pTy7v86azVfgEfsTImF2IficCIkjhDDM2rZaYesv3M2zaic0gxTDx3vYwqEknKUAe2Mmic2MRUtA/132', '0', '0', '0', '0', '木', '1', '0', '65981bb9f480a114f549a9996c46f390', '', 'hide');
INSERT INTO `clt_users` VALUES ('14', '', '', null, '2', '0', '1517553653', '0', '', '', '', '0', 'phone_weixin', 'okRTqvrmCPlTe91ydZ9zhfdfZAYs', null, 'http://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83epwO7nM7ShxZp9hZO3ibe5q40KsnfcEiaWA2rcNQIiaGW0xdZc8iatehO6fngUvyMDAv4Rwa3ic1xN8iccQ/132', '0', '0', '0', '0', '戴方敏', '1', '0', 'dc4b3a7d282b5414b83ff3a8f1a1d322', '', 'hide');
INSERT INTO `clt_users` VALUES ('15', '', '', null, '2', '0', '1517553667', '0', '', '', '', '0', 'phone_weixin', 'okRTqvsdRj2zHME5SOuZjWz1c6qE', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLKcdpTPJSkXlV2ZKGrIa9jlDy0hoe3zp1lfmMrbTbibia9AhYuyBBiccDZDL3vAgibcRvRzLntuCUkTg/132', '0', '0', '0', '0', '月明星稀', '1', '0', 'd86add4e226ae7f1791cbc329040b1f9', '', 'hide');
INSERT INTO `clt_users` VALUES ('16', '', '', null, '1', '0', '1517555733', '0', '', '', '', '0', 'phone_weixin', 'okRTqvkdFgNOObXFTcb3sN_P-KBU', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLtFGMwhmeyIul7f94bvl3vBAZoE1jibfT4R66mRahZ2kl2VcErywO0jtIVm3aLjM8OeWYD4eSOF6A/132', '0', '0', '0', '0', '黎', '1', '0', '06d85b0bc96ccf79f7b2bac90ca4e954', '', 'hide');
INSERT INTO `clt_users` VALUES ('17', '', '', null, '1', '0', '1517559520', '0', '', '', '', '0', 'phone_weixin', 'okRTqvrjJezHtF4X92qZq3b0mAIQ', null, 'http://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83ep4bqAFkP6qGIHQr6lD5hoiatWxaVmBqjv8n6Vib7OzsqhzY7HNVB1UxvickPfcdibg6rMPO3oGibNv00g/132', '0', '0', '0', '0', '大大', '1', '0', '8a0e056b6d0f9d4ae238fe311aeb9284', '', 'hide');
INSERT INTO `clt_users` VALUES ('18', '', '', null, '1', '0', '1517559744', '0', '', '', '', '0', 'phone_weixin', 'okRTqvj8OL7djsk2bMDxesJj3U0I', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLqLOibNbJ5fe9ytEP58fibNLdhjj0lypMI0Y3D0PHpVujMicJWvmtuy9tcrjS9mQYuILwjDS47wec3g/132', '0', '0', '0', '0', '西域之鹰', '1', '0', '771d8806f3bf70c8c58c271ebd2f7d7e', '', 'hide');
INSERT INTO `clt_users` VALUES ('19', '', '', null, '1', '0', '1517565505', '0', '', '', '', '0', 'phone_weixin', 'okRTqvmASUIqTWnS5I8BlCduZzCU', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJ5UGC7nIqc87JbcvbYk66AMH7r4Sy3a7bNq2kUqibzic01pmKnODcoXckfChvXGnzgkxgghcJLlL5w/132', '0', '0', '0', '0', '胡兆明', '1', '0', '57ccc77e6e37c7167eaa56478c41b57b', '', 'hide');
INSERT INTO `clt_users` VALUES ('20', '', '', null, '1', '0', '1517583573', '1517583596', '', '', '', '0', 'phone_weixin', 'okRTqvpTbGbzU9Kl5W_zv5rQiKrk', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTIQyZuJqcGw6sTicuX6qHp41YiaBsH3w9HEgydNEYLpeOMjKsnMibPCrvx2WKfoOQl0CaBPR5KjK6fhw/132', '0', '0', '0', '0', '阿强', '1', '0', '0566e50c2ffaa86fb404426e1440bace', '', 'hide');
INSERT INTO `clt_users` VALUES ('21', '', '', null, '1', '0', '1517720805', '0', '', '', '', '0', 'phone_weixin', 'okRTqvpGAN1xPCsGVG4IjQzkRycA', null, 'http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJ6DbxxgmFPXFoJvWaVWJ2yYRKlDJYQQeuboL0art579iaeDlRpuXx0pXJplB5jVmZs9Ab4nFukVeg/132', '0', '0', '0', '0', '如意小伙', '1', '0', 'fc4f63372c3e40eab623a83d16415198', '', 'hide');
...
-- ----------------------------
-- Table structure for `clt_video_folder`
-- ----------------------------
DROP TABLE IF EXISTS `clt_video_folder`;
CREATE TABLE `clt_video_folder` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '视频文件路径表',
  `streamname` varchar(255) NOT NULL COMMENT 'StreamName名称',
  `video_folder_name` varchar(255) NOT NULL COMMENT '视频文件夹路径名称',
  `video_name` varchar(255) NOT NULL COMMENT '视频名称',
  `upload_time` varchar(255) NOT NULL COMMENT 'oss上传时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=450 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_video_folder
-- ----------------------------
INSERT INTO `clt_video_folder` VALUES ('436', 'StreamName180425164300865619/', 'wj/record/AppName/StreamName180425164300865619/2018-08-14-14-02-13_2018-08-14-14-03-30.mp4', '直播频道一 2018-08-14', '2018-08-14');
INSERT INTO `clt_video_folder` VALUES ('438', 'StreamName180802121558948162/', 'wj/record/AppName/StreamName180802121558948162/2018-08-08-10-53-02_2018-08-08-10-56-10.mp4', '直播频道六 2018-08-08', '2018-08-08');
INSERT INTO `clt_video_folder` VALUES ('439', 'StreamName180802121558948162/', 'wj/record/AppName/StreamName180802121558948162/2018-08-08-15-22-59_2018-08-08-15-23-09.mp4', '直播频道六 2018-08-08', '2018-08-08');
INSERT INTO `clt_video_folder` VALUES ('440', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-01-17-27-00_2018-11-01-17-27-17.mp4', ' 2018-11-01', '2018-11-01');
INSERT INTO `clt_video_folder` VALUES ('441', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-02-14-00-42_2018-11-02-14-03-39.mp4', ' 2018-11-02', '2018-11-02');
INSERT INTO `clt_video_folder` VALUES ('442', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-13-04-28_2018-11-05-13-34-28.mp4', ' 2018-11-05', '2018-11-05');
INSERT INTO `clt_video_folder` VALUES ('443', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-13-34-28_2018-11-05-13-43-11.mp4', ' 2018-11-05', '2018-11-05');
INSERT INTO `clt_video_folder` VALUES ('444', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-14-01-34_2018-11-05-14-31-34.mp4', ' 2018-11-05', '2018-11-05');
INSERT INTO `clt_video_folder` VALUES ('445', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-14-31-34_2018-11-05-14-31-54.mp4', ' 2018-11-05', '2018-11-05');
INSERT INTO `clt_video_folder` VALUES ('446', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-15-00-34_2018-11-05-15-01-13.mp4', ' 2018-11-05', '2018-11-05');
INSERT INTO `clt_video_folder` VALUES ('447', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-15-05-55_2018-11-05-15-11-42.mp4', ' 2018-11-05', '2018-11-05');
INSERT INTO `clt_video_folder` VALUES ('448', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-15-23-48_2018-11-05-15-28-42.mp4', ' 2018-11-05', '2018-11-05');
INSERT INTO `clt_video_folder` VALUES ('449', 'StreamName181101154811895579/', 'recording/record/AppName/StreamName181101154811895579/2018-11-05-15-46-27_2018-11-05-15-47-17.mp4', ' 2018-11-05', '2018-11-05');

-- ----------------------------
-- Table structure for `clt_webex_list`
-- ----------------------------
DROP TABLE IF EXISTS `clt_webex_list`;
CREATE TABLE `clt_webex_list` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `webex_name` varchar(255) NOT NULL DEFAULT '' COMMENT 'webex账号',
  `webex_password` varchar(255) NOT NULL DEFAULT '' COMMENT 'webex密码',
  `userid` int(8) NOT NULL DEFAULT '0' COMMENT '//用户id',
  `webex_website` varchar(255) NOT NULL DEFAULT '' COMMENT '站点',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_webex_list
-- ----------------------------
INSERT INTO `clt_webex_list` VALUES ('1', 'apiadmin', 'Mmppjjbb1$', '1', 'ktyb');

-- ----------------------------
-- Table structure for `clt_whitelist_user_list`
-- ----------------------------
DROP TABLE IF EXISTS `clt_whitelist_user_list`;
CREATE TABLE `clt_whitelist_user_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '用户导入白名单',
  `pid` int(11) NOT NULL COMMENT '绑定直播频道id',
  `w_name` varchar(255) NOT NULL COMMENT '白名单用户',
  `w_pwd` varchar(255) NOT NULL COMMENT '用户密码',
  `w_time` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_whitelist_user_list
-- ----------------------------
INSERT INTO `clt_whitelist_user_list` VALUES ('25', '46', 'zql', '123', '2018-11-14 10:37:29');
INSERT INTO `clt_whitelist_user_list` VALUES ('24', '46', 'wangjin', '123', '2018-11-14 10:37:29');
INSERT INTO `clt_whitelist_user_list` VALUES ('23', '46', 'wangjiang', '123', '2018-11-14 10:37:29');
...
INSERT INTO `clt_wx_menu` VALUES ('3', '0', '动态', '', '0', '2', '4', 'http://www.cltphp.com/', '0', '3', '1514178544', '0');
