...
use think\Request;
use think\Session;
class phone_weixin extends Model{
	//回调地址
	public $return_url;
	public $app_id;
	public $app_secret;
	public function __construct($config){
		$this->return_url = "http://".$_SERVER['HTTP_HOST']."/user/loginApi/callback/oauth/phone_weixin";
	...
	public function login(){
		...
		//拼接URL
		$dialog_url = $wxurl = $url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid="
                        .$this->app_id."&redirect_uri=".$this->return_url."&response_type=code&scope=".$scope
