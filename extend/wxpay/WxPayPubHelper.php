...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://3244.sucaihuo.com/index.php/Home/Pno/wx';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://kaoji.meetv.com.cn/admin/system/wx';
...
//		if(isset($config['appid'])){
                         $apidata=db('paylist')->where(['id'=>2])->find();
                        //将配置 数据提取出来
...
//		}else{
//			/*
//			* const APPID = '1316974701';
//			//受理商ID，身份标识
//			const MCHID = 'wxe9590f00';
//			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
//			const KEY = 'yimeiquan123423456yi';
//			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
//			const APPSECRET = '4ad596266a2d';
//			 */
//			//=======【基本信息设置】=====================================
//			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
//			$this->APPID = 'wxb5aec13c030a530b';
//			//受理商ID，身份标识
//			$this->MCHID = '1267579601';
//			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
//			$this->KEY = 'abcdefghijklmnopqrstuvwxyzzqlzql';
//			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
//			$this->APPSECRET = '2232d4acc3612e530f0ccc311c72d68c';
//			//=======【证书路径设置】=====================================
//			//证书路径,注意应该填写绝对路径
//			$this->SSLCERT_PATH = './cacert/apiclient_cert.pem';
//			$this->SSLKEY_PATH = './cacert/apiclient_key.pem';
